...
/// cpu离线渲染
public class CocoOfflineRender{
    ...
    public func draw(call:(CocoOfflineRender)->Void)->CGImage?{
        call(self)
...
extension CocoOfflineRender {
    ...
    public static func contentModeFrame(itemFrame:CGRect,containerFrame:CGRect,mode:CocoContentMode)->CGRect{
        switch(mode){
        case .scaleToFill:
